      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="p-6 pb-0">
          ...
          <Tabs value={mainTab} onValueChange={setMainTab} className="w-full">
            ...
            {/* Automated Insights Tab Content - Duplicate of Insights Tab */}
              ...
              <div className="w-full">
                <div className="space-y-8">
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">Automated Insight Template Gallery</h2>
                        <p className="text-sm text-gray-600">
                          Choose from pre-built templates to quickly generate automated insights for your data
                        </p>
                      </div>
                  ...
                  {/* Automated Insights Metrics Section */}
                  <div id="automated-insights-metrics-duplicate">
                    <AutomatedInsights data={filteredData} savedTemplateInsights={savedTemplateInsights} />
                  </div>
                </div>
              </div>
